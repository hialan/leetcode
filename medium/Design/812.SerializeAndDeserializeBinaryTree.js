...
var deserialize = function (data) {
    ...
    if(arr.length === 0) {
        ...
        while(pos < arr.length) {
            ...
            if(node !== null) {
                node.left = (arr[pos] !== null) ? new TreeNode(arr[pos]) : null;
                pos++;
    
                node.right = (arr[pos] !== null) ? new TreeNode(arr[pos]) : null;
                pos++;
